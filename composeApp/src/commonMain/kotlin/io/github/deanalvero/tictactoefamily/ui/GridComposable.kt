...
@Composable
fun GridComposable(engine: GameEngine) {
    Column(Modifier.border(2.dp, Color.LightGray, RoundedCornerShape(12.dp)).padding(4.dp)) {
        engine.board.forEachIndexed { rIndex, row ->
            Row {
                row.forEachIndexed { cIndex, cell ->
                    ...
                    SquareComposable(cell, isHint, isSelected) {
